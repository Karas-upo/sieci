...
// 2. Pobieranie pytań i odpowiedzi (dodano czy_poprawna do głównego zapytania dla wydajności)
...
<body>
    ...
    <div class="header-nav">
        <a href="menu_test1.php" class="back-btn">&larr; Powrót</a>
        ...
        <?php foreach ($quiz as $p_id => $q): ?>
            ...
            <div class="question-card <?php echo $card_class; ?>">
                ...
                <?php if ($q['obrazek'] !== 'false' && !empty($q['obrazek'])): ?>
                    <div class="image-box">
                        <img src="img/<?php echo $q['obrazek']; ?>" alt="Grafika">
                    </div>
                <?php endif; ?>
