...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['test_ids'])) {
    ...
    // ZMIANA: pytania -> pytania2, odpowiedzi -> odpowiedzi2
    ...
    // ZMIANA: pytania -> pytania2
    $random_ids_res = $conn->query("SELECT id FROM pytania2 ORDER BY RAND() LIMIT 33");
    $ids_array = [];
...
<head>
    <meta charset="UTF-8">
    <title>Egzamin - Recenzja (Tabela 2)</title>
    <style>
...
<body>
    ...
    <div class="nav-top">
        <a href="menu_test2.php" class="btn-back">&larr; <b>Powrót</b></a>
        <h2>Egzamin: 33 pytania (Baza v2)</h2>
    </div>
    ...
    <form method="POST">
        ...
        <?php else: ?>
            <a href="test2_33.php" class="btn-action btn-new">Rozpocznij nowy test</a>
        <?php endif; ?>
    </form>
